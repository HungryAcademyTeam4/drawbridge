...
APPLICATION_NAME = "Drawbridge"
SCRIPT_NAME = "drawbridge"
REPOSITORY = "git://github.com/HungryAcademyTeam4/drawbridge.git"
START_COMMAND = 'unicorn /apps/Drawbridge/current/config.ru -p 3001'
